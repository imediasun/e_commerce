...
//COlors
     ...
     if(!empty($main_array['color_siren']) ){
         $colors_set['color_siren']= $main_array['color_siren'];}
     if(!empty($main_array['color_dark_pink']) ){
         $colors_set['color_dark_pink']= $main_array['color_dark_pink'];}
     ...
     if(!empty($main_array['color_broun']) ){
         $colors_set['color_broun']= $main_array['color_broun'];}
     ...
     if(!empty($main_array['color_dark_brown']) ){
         $colors_set['color_dark_brown']= $main_array['color_dark_brown'];}
     if(!empty($main_array['color_light_green']) ){
         $colors_set['color_light_green']= $main_array['color_light_green'];}

     if(isset($colors_set) ){
         $colors_set['id_good']= $last_data_object+1;
